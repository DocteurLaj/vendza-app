...
class ShareImageResolver {
  ...
  static Future<XFile?> resolve(String imagePath) async {
  ...
  static Future<XFile?> _assetToXFile(String assetPath) async {
  ...
  static Future<XFile?> _networkToXFile(String url) async {
  ...
  static String _extensionFromUrl(String url, String? contentType) {
